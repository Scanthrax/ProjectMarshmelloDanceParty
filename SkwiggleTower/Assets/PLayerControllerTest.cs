...
public class PLayerControllerTest : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        source = AudioManager.instance.AddSource(gameObject, Sounds.AsphaltFootsteps,SoundChannels.Footsteps);
    }
    ...
    /// <summary>
    /// Used by a signal in the intro cutscene to control when the player can control the cube
    /// </summary>
